    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/Grid").Include(
                        ...
                        "~/Scripts/jqGrid/gridPersonalizado.js"
            ));


            bundles.Add(new ScriptBundle("~/bundles/utilitarios").Include(
            "~/Scripts/Utilidades/Utilitarios.js"
            ));

            bundles.Add(new StyleBundle("~/bundles/content/Grid").Include("~/Content/jqGrid/jquery.jqGrid-4.5.4/css/ui.jqgrid.css",
                               "~/Content/GridPersonalizado.css"));
        }
    }
}
